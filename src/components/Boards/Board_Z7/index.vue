      ...
      <template #left>
        <board-offsets :b="390" :l="156" :r="184" :t="139">
          <board-text-body
            offset="88px"
            icon="trassa"
            text="Произведен полив улиц, км"
            v-space-m:bottom="'35px'"
          />
          <board-numbers
            :value="type.wateringOfStreets_km"
            color="negative"
            size="lg"
            showDynamic
            dynamic
        ...
        <board-offsets :b="154" :l="136" :r="220" :t="209">
          <board-offsets>
            <board-text-body
              ...
              icon="dvor"
              offset="89px"
              text="Произведен полив дворов"
              sizeText="caption"
              v-space-m:bottom="'39px'"
            />
            <board-numbers
              :value="type.yardsWereWatered"
              color="positive"
              size="sm"
              showDynamic
              dynamic
            ...
            <board-text-body
              ...
              icon="dry-road"
              offset="89px"
              text="Произведен полив дорог, км"
              sizeText="caption"
              v-space-m:bottom="'39px'"
            />
            <board-numbers
              :value="type.wateringOfRoads_km"
              color="positive"
              size="sm"
              showDynamic
              dynamic

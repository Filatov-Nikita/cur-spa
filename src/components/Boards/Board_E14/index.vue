<template>
  <board-cover>
    <board-devider :cols="3">
      <template #section1>
        <board-offsets :l="95" :t="99" :b="76" :r="125">
          <board-text-body
            offset="82px"
            icon="co2"
          ...
          <board-numbers
            :value="type.numberOfIncidentsAtTheTop"
            color="negative"
            size="md"
            showDynamic
            :dynamic="false"
          ...
          <board-period-numbers
            ...
            :valueStg="{
              color: 'negative',
              value: type.numberOfIncidentsInTheMiddle,
              size: 'sm',
            }"
      ...
      <template #section2>
        <board-offsets :l="112" :t="97" :b="76" :r="96">
          <board-text-body
            offset="116px"
            icon="affected"
          ...
          <board-numbers
            :value="type.numberOfVictimsTheTop"
            color="positive"
            size="md"
            showDynamic
            :dynamic="false"
          ...
          <board-period-numbers
            ...
            :valueStg="{
              color: 'negative',
              value: type.numberOfVictimsTheMiddle,
              size: 'sm',
            }"
            v-space-m:bottom="'55px'"
          />
      ...
      <template #section3>
        <board-offsets :l="87" :t="96" :b="76" :r="123">
          <board-text-body
            sizeText="caption"
            offset="70px"
            icon="died"
          ...
          <board-period-numbers
            ...
            :valueStg="{
              color: 'negative',
              value: type.theDeathTollInTheMiddle,
              size: 'sm',
            }"
            v-space-m:bottom="'55px'"
          />
